    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0D1117]">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#161B22] border border-[#30363D] rounded-lg p-6">
          <h1 className="text-lg font-semibold mb-5 text-[#E6EDF3]">Iniciar sesión</h1>
          ...
          {/* Google — siempre visible. Si no hay credenciales en backend
              NextAuth no registra el provider y el click muestra error. */}
          <button
            type="button"
            onClick={() => signIn('google', { callbackUrl: '/dashboard' })}
            className="w-full flex items-center justify-center gap-3 bg-[#0D1117] border border-[#30363D] hover:border-[#484F58] rounded px-3 py-2 text-sm text-[#E6EDF3] transition-colors mb-4"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0D1117] border border-[#30363D] rounded px-3 py-2 text-sm text-[#E6EDF3] placeholder:text-[#6E7681] focus:outline-none focus:border-[#58A6FF] transition-colors"
